...
c      WRITE(*,*)' Do you want medians (0) or averages (1)?'
      READ(*,*)ianswer
c      WRITE(*,*)' '
      READ(*,*)outfile
      ...
      ELSE
        IF (ianswer.EQ.0) THEN
          ...
          apar4 = 0.1481
          apar5 = 0.3096
c          outfile = 'PWGH_median.dat'
c          WRITE(*,*)'   >>> Computing median MAH & PWGH <<<'
        ELSE
          apar1 = 3.2954
          apar2 = 0.1975
          apar3 = 0.7542
          apar4 = 0.0898
          apar5 = 0.4415
c          outfile = 'PWGH_average.dat'
c          WRITE(*,*)'   >>> Computing average MAH & PWGH <<<'
        END IF
      END IF
...
c---set time and redshift sampling; we sample log(1+z) linearly
      ...
      DO j=1,Nz
        xlgz = ALOG10(1.0+z0) +
     &       FLOAT(j-1)/FLOAT(Nz-1) * (0.85 - ALOG10(1.0+z0))
...
c      WRITE(*,*)' Give Omega_{m,0} : '
      READ(*,*)omega_0
c      WRITE(*,*)' '

c      WRITE(*,*)' Give h (=H_0/100) : '
      READ(*,*)xhubble
c      WRITE(*,*)' '

c      WRITE(*,*)' Give sigma_8 : '
      READ(*,*)sigma8
c      WRITE(*,*)' '

c      WRITE(*,*)' Give nspec (Harrisson-Zeldovich = 1.0)'
      READ(*,*)nspec
c      WRITE(*,*)' '

c      WRITE(*,*)' Give Omega_b h^2 : '
      READ(*,*)omega_b_h2
c      WRITE(*,*)' '
...
c      c(*,*)' Give halo mass at redshift z_0 (in Msun/h)'
      READ(*,*)M0
c      WRITE(*,*)' '

c      WRITE(*,*)' Give redshift z_0'
      READ(*,*)z0
c      WRITE(*,*)' '
...
c      WRITE(*,*)'-------------------------------------------'
c      WRITE(*,77)'         Omega_{m,0} =',omega_0
c      WRITE(*,77)'         Omega_{L,0} =',omega_lambda
c      WRITE(*,77)'         Omega_{b,0} =',omega_b
c      WRITE(*,77)'  H_0/(100 km/s/Mpc) =',xhubble
c      WRITE(*,77)'             sigma_8 =',sigma8
c      WRITE(*,77)'                 n_s =',nspec
c      WRITE(*,77)'            log[M_0] =',ALOG10(M0)
c      WRITE(*,77)'                 z_0 =',z0
c      WRITE(*,*)'-------------------------------------------'
c      WRITE(*,*)' '
...
c        WRITE(*,*)' ALARM IN ZRIDDR ',x1,x2,fl,fh
