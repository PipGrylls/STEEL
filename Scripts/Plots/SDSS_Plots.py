...
class SDSS_Plots:
    ...
    def __init__(self, HM_min, HM_max, HM_bin, Photomotry = "SerExp"):
        ...
        if "sdssVir.npy" in os.listdir(path="./Data/Observational/Bernardi_SDSS"):
            self.df_sat.insert(loc= len(Header), column = "mhVir", value = np.load("./Data/Observational/Bernardi_SDSS/sdssVir.npy")+0.025) #+0.025 is correction to planc15 cosmology 
        else:
            ...
            np.save("./Data/Observational/Bernardi_SDSS/sdssVir", self.df_sat.mhVir)
