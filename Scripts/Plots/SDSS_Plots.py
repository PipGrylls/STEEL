...
class SDSS_Plots:
    ...
    def __init__(self, HM_min, HM_max, HM_bin, Photomotry = "SerExp"):
        ...
        df = pd.read_csv("./Bernardi_SDSS/new_catalog_SFRs.dat", header = None, names = Header, delim_whitespace = True, skiprows = 1)
        ...
        df_new = pd.read_csv("./Lorenzo_SDSS/new_catalog_cModel.dat", header = None, names = Header, delim_whitespace = True, skiprows = 1)
        ...
        if "sdssVir.npy" in os.listdir(path="./Bernardi_SDSS"):
            self.df_sat.insert(loc= len(Header), column = "mhVir", value = np.load("./Bernardi_SDSS/sdssVir.npy")+0.025) #+0.025 is correction to planc15 cosmology 
        else:
            ...
            np.save("./Bernardi_SDSS/sdssVir", self.df_sat.mhVir)
